...
function resetpassword({navigation, route}) {
  ...
  const loginValidationSchema = yup.object().shape({
    ...
    confirmpass: yup.string().matches(newpass, 'Password does not match'),
          ...
          <View>
            ...
            {isValidPass ? (
              <Text style={styles.ErrorPass}>
                The password will need to have atleast:
              </Text>
            ) : null}

            {isValidPass1 ? (
              <Text style={style1 ? styles.ErrorPass1G : styles.ErrorPass1}>
                ✓ 10 characters
              </Text>
            ) : null}

            {isValidPass2 ? (
              <Text style={style2 ? styles.ErrorPass2G : styles.ErrorPass2}>
                ✓ 1 upper case character
              </Text>
            ) : null}

            {isValidPass3 ? (
              <Text style={style3 ? styles.ErrorPass3G : styles.ErrorPass3}>
                ✓ 1 lower case character
              </Text>
            ) : null}

            {isValidPass4 ? (
              <Text style={style4 ? styles.ErrorPass4G : styles.ErrorPass4}>
                ✓ special character
              </Text>
            ) : null}
            ...
            {formik.errors.confirmpass && (
              <Text style={styles.ErrorPasstwo}>
                {formik.errors.confirmpass}
              </Text>
            )}
            ...
            <TouchableHighlight
              style={
                !formik.values.resetcode || !formik.values.confirmpass
                  ? styles.resetbtndis
                  : styles.resetbtn
              }
